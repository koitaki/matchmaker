...
from .models import Question, Answer, MatchAnswer, UserAnswer
...
def points(request_user, matched_user):
    ...
    print "Out of %s questions, %s points were awarded of %s points with a score of %s" % (total_questions, points_awarded, points_possible, percentage)
